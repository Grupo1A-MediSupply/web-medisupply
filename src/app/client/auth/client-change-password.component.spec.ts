...
describe('ClientChangePasswordComponent', () => {
  ...
  it('should handle form state changes', () => {
    ...
    component.changePasswordForm.get('newPassword')?.setValue('test');
  ...
  it('should handle form reset functionality', () => {
    ...
    component.changePasswordForm.reset();
    
    expect(component.changePasswordForm.get('newPassword')?.value).toBeNull();
    expect(component.changePasswordForm.get('confirmPassword')?.value).toBeNull();
  });
  ...
  it('should handle component lifecycle events', () => {
    ...
    component.changePasswordForm.patchValue({ newPassword: 'test' });
    fixture.detectChanges();
    expect(component.changePasswordForm.get('newPassword')?.value).toBe('test');
  });
});