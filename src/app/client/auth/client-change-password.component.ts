  ...
  <div class="change-password-page">
    ...
    <div class="change-password-right-section">
      <div class="change-password-form-container">
        <h1 class="change-password-title">Cambiar contraseña - Cliente</h1>
        ...
        <div class="change-password-info">
          ...
          <div class="role-switch">
            <a routerLink="/vendor/change-password" class="role-link">¿Eres vendedor? Cambia tu contraseña aquí</a>
          </div>
        </div>
      </div>
    </div>
