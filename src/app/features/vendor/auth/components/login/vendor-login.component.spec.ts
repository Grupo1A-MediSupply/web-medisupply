...
describe('VendorLoginComponent', () => {
  ...
  it('should set vendor role and navigate to vendor MFA on valid login', () => {
    ...
    component._form.patchValue({ user: 'vendedor@test.com', pass: 'password123' });
  ...
  it('should handle login with different vendor credentials', () => {
    ...
    component._form.patchValue({ user: 'vendor2@test.com', pass: 'vendorpass123' });
  ...
  it('should be valid with proper inputs', () => {
    component._form.patchValue({ user: 'validvendor@test.com', pass: 'validpass123' });
    fixture.detectChanges();
  ...
  it('should handle form submission with valid data', () => {
    ...
    component._form.patchValue({ user: 'vendoruser@test.com', pass: 'vendorpass123' });
  ...
  it('should handle edge case with very long password', () => {
    ...
    component._form.patchValue({ user: 'vendor@test.com', pass: longPassword });
    fixture.detectChanges();
  ...
  it('should handle multiple login attempts', () => {
    ...
    // First login attempt
    component._form.patchValue({ user: 'vendor1@test.com', pass: 'pass123456' });
    component.login();
    
    // Second login attempt
    component._form.patchValue({ user: 'vendor2@test.com', pass: 'pass456789' });
    component.login();
  ...
  it('should handle form validation edge cases', () => {
    ...
    component._form.patchValue({ user: 'vendor@test.com', pass: 'password123' });
    expect(component._form.valid).toBeTruthy();
  });
  ...
  it('should handle form validation errors', () => {
    ...
    component._form.patchValue({ user: 'testvendor@test.com' });
    expect(component._form.invalid).toBeTruthy();
    ...
    component._form.patchValue({ user: 'testvendor@test.com', pass: 'testpass123' });
    expect(component._form.valid).toBeTruthy();
  });
  ...
  it('should handle login with different user types', () => {
    ...
    // Test vendor login
    component._form.patchValue({ user: 'proveedor@test.com', pass: 'password123' });
    component.login();
  ...
  it('should handle invalid login credentials', () => {
    ...
    // El componente navega a MFA si el servicio retorna mfaRequired
    expect(mockRouter.navigate).toHaveBeenCalledWith(['/vendor/mfa']);
  });
